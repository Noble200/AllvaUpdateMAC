...
public partial class ManageAdministradoresAllvaViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    private AdministradorAllvaModel? _administradorAEliminar;
    ...
    /// </summary>
    [RelayCommand]
    private void EliminarAdministrador(AdministradorAllvaModel admin)
    {
        AdministradorAEliminar = admin;
    ...
    /// </summary>
    [RelayCommand]
    private void CancelarEliminarAdministrador()
    {
    ...
    /// <summary>
    /// Confirma y ejecuta la eliminación del administrador
    /// </summary>
    [RelayCommand]
    private async Task ConfirmarEliminarAdministrador()
    {
        if (AdministradorAEliminar == null) return;
        ...
        try
        {
            ...
            try
            {
                ...
                deleteModulosCmd.Parameters.AddWithValue("@Id", AdministradorAEliminar.IdAdministrador);
                ...
                deleteAdminCmd.Parameters.AddWithValue("@Id", AdministradorAEliminar.IdAdministrador);
