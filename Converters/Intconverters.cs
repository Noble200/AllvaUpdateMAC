...
/// <summary>
/// Conversor que compara un entero con el parametro y devuelve true si son iguales
/// Usado para estilizar botones de posicion activos
/// </summary>
...
/// <summary>
/// Conversor que compara un entero con el parametro y devuelve true si son diferentes
/// Usado para estilizar botones de posicion inactivos
/// </summary>
public class IntNotEqualityConverter : IValueConverter
{
    public static readonly IntNotEqualityConverter Instance = new();
